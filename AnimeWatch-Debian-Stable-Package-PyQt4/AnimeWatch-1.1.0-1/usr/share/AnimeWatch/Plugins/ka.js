...
if ((/https:\/\/.+?\.css|https:\/\/.+?\.jpg|https:\/\/.+?\.gif|https:\/\/.+?\.png|https:\/\/.+?\.aspx|https:\/\/.+?\google|https:\/\/.+?\facebook|https:\/\/.+?\plugins/gi).test(requestData['url']) || requestData.headers['Content-Type'] == 'text/css|image/jpeg') {
...
function getCookies() {
  ...
  Object.keys(phantom.cookies).forEach(function (key) {
    ...
    if (!/kissanime.to$/.test(cookie.domain)) return;
    cookies.push(cookie);
  });
  return cookies;
} 
