...
def cloudfareUrl(url, quality=None, cookie=None, get_link=None, get_cookie=None, 
...
class SubbedAnime():
    ...
    def getOptions(self):
            self.criteria = [
                'Anime1', 'Anime44', 'AnimePlus', 'AnimeWow', 'Animehere',
                'GoodAnime', 'AnimeOut', 'AnimeNet', 'AnimeStream', 'Animefun',
                'Animegalaxy', 'Animebox', 'Anime-Freak', 'AnimeHQ',
                'AnimeSquare', 'Animeget', 'newversion'
                ]
                ...
                if 'checking_browser' in content:
                    ...
                    if hls_path:
                        ans = cloudfare(
                                ...
                                tmp_dir=self.tmp_dir, end_pt=end_pt)
                    else:
                        cloudfare(
                            url, cookie=self.cookie_file, get_cookie=True, 
                            tmp_dir=self.tmp_dir, end_pt=end_pt)
    ...
    def getEpnList(self, name, opt, depth_list, extra_info, site_name, category):
        global siteName
        url = ""
        depth_list = 1
        display_list = True
    ...
    def getFinalUrl(self, name, epn, mirrorNo, quality):
        global qualityVideo, siteName, category
